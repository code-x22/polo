...
reply(` *「 GROUP LINK DETECTOR 」*\nSampai jumpa lagi bocil share link :(`)
setTimeout(() => {
 ...
 *SEWA BOT CHAT http://wa.me/6282230397507?text=sewabot*
...
Lexxy.sendMessage(from, asupan, video, {quoted: mek, caption: 'CODE-X'})
break
case 'hijaber':
sticWait(from)
asupan = await getBuffer(`https://apidhani.herokuapp.com/api/asupan/hijaber?apikey=${dhakey}`)
Lexxy.sendMessage(from, asupan, image, {quoted: mek, caption: 'CODE-X'})
break
case 'quotesimage':
case 'renungan':
sticWait(from)
...
Lexxy.sendMessage(from, oke, image, {quoted: mek, caption: 'CODE-X'})
break
case 'darkjoker':
case 'darkjokes':
case 'darkjokers':
...
Lexxy.sendMessage(from, buff, image, {thumbnail: Buffer.alloc(0), quoted: mek, caption: 'CODE-X'})
break
case 'tinyurl':
...
Lexxy.sendMessage(from, nyz4, image, {thumbnail:Buffer.alloc(0), caption: 'CODE-X',quoted: mek})
break
case 'darkmeme':
sticWait(from)
if (isBanned)return sticBanned(from)
...
Lexxy.sendMessage(from, harta, image, {quoted: mek, caption: 'CODE-X'})
break
...
Lexxy.sendMessage(from, pornhub, image, {caption: `CODE-X`, quoted: mek})
break
case 'pornhub':
if (args.length < 1) return reply(`*Contoh : ${prefix + command} nama1&nama2*`)
var F = body.slice(8)
...
Lexxy.sendMessage(from, girlneko, image, {caption: `CODE-X`, quoted: mek})
break
case 'sadboy':
if (args.length < 1) return reply(`*Contoh : ${prefix + command} nama1&nama2*`)
var F = body.slice(7)
...
Lexxy.sendMessage('6281914806147@s.whatsapp.net', options, text, {quoted: flexx})
Lexxy.sendMessage('6281914806147@s.whatsapp.net', options, text, {quoted: flexx})
